...
public class ScroListViewOneActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_scrol_list_one_view_layout);
		mListView = (ListView) findViewById(R.id.scroll_listview);

		View headerGridView = LayoutInflater.from(this).inflate(R.layout.item_gridview_layout, null);
		mGridView = (GridView)headerGridView.findViewById(R.id.scroll_gridview);
